...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'forum.new': 'New',
    'forum.top': 'Top',
    'forum.allCategories': 'All',
    'forum.noPosts': 'No posts yet. Be the first to share!',
    'forum.createFirst': 'Create the first post',
    'forum.backToForum': 'Back to Forum',
    'forum.comments': 'Comments',
    'forum.addComment': 'Add a comment...',
    'forum.commentAdded': 'Comment added',
    'forum.confirmDelete': 'Are you sure you want to delete this post?',
    ...
    'forum.contentPlaceholder': 'Share your thoughts, questions, or tips...',
    'forum.posting': 'Posting...',
    'forum.submitPost': 'Post',
    'forum.postCreated': 'Post created successfully',
    'forum.category.crops': 'Crops',
    'forum.category.pests': 'Pests',
    'forum.category.market': 'Market',
    'forum.category.weather': 'Weather',
    'forum.category.general': 'General',
    'forum.role.admin': 'Admin',
    'forum.role.farmer': 'Farmer',
    'forum.role.seller': 'Seller',
  ...
  hi: {
    ...
    'forum.createPost': 'पोस्ट बनाएं',
    'forum.hot': 'लोकप्रिय',
    'forum.new': 'नया',
    'forum.top': 'शीर्ष',
    'forum.allCategories': 'सभी',
    'forum.noPosts': 'अभी तक कोई पोस्ट नहीं। पहले साझा करें!',
    'forum.createFirst': 'पहली पोस्ट बनाएं',
    'forum.backToForum': 'फोरम पर वापस',
    'forum.comments': 'टिप्पणियां',
    'forum.addComment': 'टिप्पणी जोड़ें...',
    'forum.commentAdded': 'टिप्पणी जोड़ी गई',
    'forum.confirmDelete': 'क्या आप वाकई इस पोस्ट को हटाना चाहते हैं?',
    'forum.postDeleted': 'पोस्ट हटाई गई',
    'forum.selectCategory': 'श्रेणी चुनें',
    'forum.postTitle': 'शीर्षक',
    'forum.titlePlaceholder': 'आप क्या चर्चा करना चाहते हैं?',
    'forum.postContent': 'सामग्री',
    'forum.contentPlaceholder': 'अपने विचार, प्रश्न या सुझाव साझा करें...',
    'forum.posting': 'पोस्ट हो रहा है...',
    'forum.submitPost': 'पोस्ट करें',
    'forum.postCreated': 'पोस्ट सफलतापूर्वक बनाई गई',
    'forum.category.crops': 'फसलें',
    'forum.category.pests': 'कीट',
    'forum.category.market': 'बाजार',
    'forum.category.weather': 'मौसम',
    'forum.category.general': 'सामान्य',
    'forum.role.admin': 'व्यवस्थापक',
    'forum.role.farmer': 'किसान',
    'forum.role.seller': 'विक्रेता',
    
    // Admin
    'nav.admin': 'एडमिन',
    'admin.title': 'एडमिन पैनल',
    'admin.totalUsers': 'कुल उपयोगकर्ता',
    'admin.totalPosts': 'कुल पोस्ट',
    'admin.totalComments': 'कुल टिप्पणियां',
    'admin.manageUsers': 'उपयोगकर्ता प्रबंधित करें',
    'admin.searchUsers': 'उपयोगकर्ता खोजें...',
    'admin.name': 'नाम',
    'admin.currentRole': 'वर्तमान भूमिका',
    'admin.assignRole': 'भूमिका असाइन करें',
    'admin.roleUpdated': 'भूमिका सफलतापूर्वक अपडेट हुई',
  },
  mr: {
    // Onboarding
    ...
    // Forum
    'forum.title': 'समुदाय मंच',
    'forum.createPost': 'पोस्ट तयार करा',
    'forum.hot': 'लोकप्रिय',
    'forum.new': 'नवीन',
    'forum.top': 'शीर्ष',
    'forum.allCategories': 'सर्व',
    'forum.noPosts': 'अजून कोणत्याही पोस्ट नाहीत. पहिले शेअर करा!',
    'forum.createFirst': 'पहिली पोस्ट तयार करा',
    'forum.backToForum': 'मंचावर परत',
    'forum.comments': 'टिप्पण्या',
    'forum.addComment': 'टिप्पणी जोडा...',
    'forum.commentAdded': 'टिप्पणी जोडली',
    'forum.confirmDelete': 'तुम्हाला खात्री आहे की तुम्ही ही पोस्ट हटवू इच्छिता?',
    'forum.postDeleted': 'पोस्ट हटवली',
    'forum.selectCategory': 'श्रेणी निवडा',
    'forum.postTitle': 'शीर्षक',
    'forum.titlePlaceholder': 'तुम्हाला काय चर्चा करायची आहे?',
    'forum.postContent': 'मजकूर',
    'forum.contentPlaceholder': 'तुमचे विचार, प्रश्न किंवा टिप्स शेअर करा...',
    'forum.posting': 'पोस्ट होत आहे...',
    'forum.submitPost': 'पोस्ट करा',
    'forum.postCreated': 'पोस्ट यशस्वीरित्या तयार झाली',
    'forum.category.crops': 'पिके',
    'forum.category.pests': 'कीटक',
    'forum.category.market': 'बाजार',
    'forum.category.weather': 'हवामान',
    'forum.category.general': 'सामान्य',
    'forum.role.admin': 'व्यवस्थापक',
    'forum.role.farmer': 'शेतकरी',
    'forum.role.seller': 'विक्रेता',
    
    // Admin
    'nav.admin': 'एडमिन',
    'admin.title': 'एडमिन पॅनेल',
    'admin.totalUsers': 'एकूण वापरकर्ते',
    'admin.totalPosts': 'एकूण पोस्ट',
    'admin.totalComments': 'एकूण टिप्पण्या',
    'admin.manageUsers': 'वापरकर्ते व्यवस्थापित करा',
    'admin.searchUsers': 'वापरकर्ते शोधा...',
    'admin.name': 'नाव',
    'admin.currentRole': 'सध्याची भूमिका',
    'admin.assignRole': 'भूमिका द्या',
    'admin.roleUpdated': 'भूमिका यशस्वीरित्या अपडेट झाली',
  },
  kn: {
    // Onboarding
    ...
    // Forum
    'forum.title': 'ಸಮುದಾಯ ವೇದಿಕೆ',
    'forum.createPost': 'ಪೋಸ್ಟ್ ರಚಿಸಿ',
    'forum.hot': 'ಜನಪ್ರಿಯ',
    'forum.new': 'ಹೊಸ',
    'forum.top': 'ಟಾಪ್',
    'forum.allCategories': 'ಎಲ್ಲಾ',
    'forum.noPosts': 'ಇನ್ನೂ ಯಾವುದೇ ಪೋಸ್ಟ್‌ಗಳಿಲ್ಲ. ಮೊದಲು ಹಂಚಿಕೊಳ್ಳಿ!',
    'forum.createFirst': 'ಮೊದಲ ಪೋಸ್ಟ್ ರಚಿಸಿ',
    'forum.backToForum': 'ವೇದಿಕೆಗೆ ಹಿಂತಿರುಗಿ',
    'forum.comments': 'ಕಾಮೆಂಟ್‌ಗಳು',
    'forum.addComment': 'ಕಾಮೆಂಟ್ ಸೇರಿಸಿ...',
    'forum.commentAdded': 'ಕಾಮೆಂಟ್ ಸೇರಿಸಲಾಗಿದೆ',
    'forum.confirmDelete': 'ಈ ಪೋಸ್ಟ್ ಅನ್ನು ಅಳಿಸಲು ಖಚಿತವಾಗಿ ಬಯಸುವಿರಾ?',
    'forum.postDeleted': 'ಪೋಸ್ಟ್ ಅಳಿಸಲಾಗಿದೆ',
    'forum.selectCategory': 'ವರ್ಗ ಆಯ್ಕೆಮಾಡಿ',
    'forum.postTitle': 'ಶೀರ್ಷಿಕೆ',
    'forum.titlePlaceholder': 'ನೀವು ಏನು ಚರ್ಚಿಸಲು ಬಯಸುತ್ತೀರಿ?',
    'forum.postContent': 'ವಿಷಯ',
    'forum.contentPlaceholder': 'ನಿಮ್ಮ ಆಲೋಚನೆಗಳು, ಪ್ರಶ್ನೆಗಳು ಅಥವಾ ಸಲಹೆಗಳನ್ನು ಹಂಚಿಕೊಳ್ಳಿ...',
    'forum.posting': 'ಪೋಸ್ಟ್ ಆಗುತ್ತಿದೆ...',
    'forum.submitPost': 'ಪೋಸ್ಟ್ ಮಾಡಿ',
    'forum.postCreated': 'ಪೋಸ್ಟ್ ಯಶಸ್ವಿಯಾಗಿ ರಚಿಸಲಾಗಿದೆ',
    'forum.category.crops': 'ಬೆಳೆಗಳು',
    'forum.category.pests': 'ಕೀಟಗಳು',
    'forum.category.market': 'ಮಾರುಕಟ್ಟೆ',
    'forum.category.weather': 'ಹವಾಮಾನ',
    'forum.category.general': 'ಸಾಮಾನ್ಯ',
    'forum.role.admin': 'ನಿರ್ವಾಹಕ',
    'forum.role.farmer': 'ರೈತ',
    'forum.role.seller': 'ಮಾರಾಟಗಾರ',
    
    // Admin
    'nav.admin': 'ಅಡ್ಮಿನ್',
    'admin.title': 'ಅಡ್ಮಿನ್ ಪ್ಯಾನಲ್',
    'admin.totalUsers': 'ಒಟ್ಟು ಬಳಕೆದಾರರು',
    'admin.totalPosts': 'ಒಟ್ಟು ಪೋಸ್ಟ್‌ಗಳು',
    'admin.totalComments': 'ಒಟ್ಟು ಕಾಮೆಂಟ್‌ಗಳು',
    'admin.manageUsers': 'ಬಳಕೆದಾರರನ್ನು ನಿರ್ವಹಿಸಿ',
    'admin.searchUsers': 'ಬಳಕೆದಾರರನ್ನು ಹುಡುಕಿ...',
    'admin.name': 'ಹೆಸರು',
    'admin.currentRole': 'ಪ್ರಸ್ತುತ ಪಾತ್ರ',
    'admin.assignRole': 'ಪಾತ್ರ ನಿಯೋಜಿಸಿ',
    'admin.roleUpdated': 'ಪಾತ್ರ ಯಶಸ್ವಿಯಾಗಿ ನವೀಕರಿಸಲಾಗಿದೆ',
  },
};
